 ...
 * @LastEditTime: 2019-09-19 15:26:31
 */
 ...
 * @description: 全局通知提醒
 * @param {type} 类型
 * @param {message} 提示title
 * @param {description} 描述
 * @param {cancel} 是否取消提示框自动关闭
 * @return: 
 */
const openNotification = (type, message, description, cancel) => {
  let duration = cancel ? 0 : 4.5
  notification[type]({
    message: message,
